...
import static com.ejs.birthchart.prototipe.util.ExtendedMath.PI2;
...
import com.ejs.birthchart.prototipe.util.Pegasus;
...
public class MoonPhase {
    ...
    public MoonPhase(ZonedDateTime time, double distance) {
        this.time = time;
    ...
    public enum Phase {
        ...
        public static Phase toPhase(double angle) {
            ...
            if (normalized > 270 && normalized < 365.5) {
    ...
    public static class MoonPhaseBuilder extends BaseBuilder<Parameters> implements Parameters {
        ...
        private double phase = Phase.FULL_MOON.getAngleRad();
         ...
         */
        public double moonphase(JulianDate jd, double t) {
