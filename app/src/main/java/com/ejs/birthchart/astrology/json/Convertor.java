package com.ejs.birthchart.astrology.json;
...
public class Convertor {
	 ...
	 *  
	 * @param planetsPositions The output from class cz.kibo.api.astrology.domain.Planet
	 */
	public Convertor( Map<String, List<Double>> planetsPositions ) throws JSONException {
	 ...
	 *  
	 * @param cuspsPositions planets The output from class cz.kibo.api.astrology.domain.Cusp
	 */
	public Convertor( List<Double> cuspsPositions ) throws JSONException {
