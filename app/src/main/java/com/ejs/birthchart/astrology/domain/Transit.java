...
public class Transit extends Ephemeris{
	 ...
	 * @param planet The transiting planet. Constants of planets are in {@link SweConst}.
	...
	public Transit( LocalDateTime event, Integer planet, Double point, int iflag, boolean backwards) {
		...
		this.planet = planet;
		this.point = point;
		this.iflag = SweConst.SEFLG_MOSEPH | SweConst.SEFLG_TRANSIT_LONGITUDE;
	...
	public Transit( LocalDateTime event, Integer planet, Double point, Coordinates coords, int iflag, boolean backwards) {
		...
		this.point = point;
		this.coords = coords;
		this.iflag = SweConst.SEFLG_MOSEPH | SweConst.SEFLG_TRANSIT_LONGITUDE | SweConst.SEFLG_TOPOCTR;
