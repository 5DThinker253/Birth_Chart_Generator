package com.ejs.birthchart.astrology.builder;

import java.time.LocalDateTime;

import com.ejs.birthchart.astrology.domain.Coordinates;
import com.ejs.birthchart.astrology.domain.Transit;
...
public class TransitBuilder extends Builder{
	 ...
	 * 
	 * @param planetName The transiting planet.
	 * @return
	 */
	 ...
	 * 
	 * @param planetName The second planet that will be transited by the first planet.
	 * @return
	 */
